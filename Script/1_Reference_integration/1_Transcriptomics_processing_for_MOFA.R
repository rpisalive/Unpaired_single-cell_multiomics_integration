...
write.csv(rna_df, file = "MOFA/input/5_MOFA_complied_preprocessing/transcriptomics_for_MOFA.csv",
...
write.csv(metadata, file = "MOFA/input/5_MOFA_complied_preprocessing/transcriptomics_metadata.csv",
          row.names = FALSE, quote = FALSE)
