...
write.csv(prot_df, file = "SCOT_plus/input/proteomics_for_SCOT.csv", row.names = FALSE,
          quote = FALSE)

write.csv(data.frame(coldata, check.names = FALSE),
          file = "SCOT_plus/input/proteomics_metadata.csv", row.names = FALSE, quote = FALSE)
